...
const cargarUsuarios = async () => {
    const url = `/contreras_final_comisiones_ingsoft1/permisos/buscarUsuariosAPI`;
    const config = {
        method: 'GET'
    }
...
const cargarAplicaciones = async () => {
    const url = `/contreras_final_comisiones_ingsoft1/permisos/buscarAplicacionesAPI`;
    const config = {
        method: 'GET'
    }
...
const guardarPermiso = async e => {
    ...
    const url = "/contreras_final_comisiones_ingsoft1/permisos/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarPermisos = async () => {
    const url = `/contreras_final_comisiones_ingsoft1/permisos/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const limpiarTodo = () => {
    ...
    document.getElementById('permiso_tipo').value = 'FUNCIONAL';
}
...
const ModificarPermiso = async (event) => {
    ...
    const body = new FormData(formPermiso);
    const url = '/contreras_final_comisiones_ingsoft1/permisos/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarPermisos = async (e) => {
    ...
    if (!idPermiso || idPermiso === 'undefined') {
        await Swal.fire({
            position: "center",
            icon: "error",
            title: "Error",
            text: "No se pudo obtener el ID del permiso",
            showConfirmButton: true,
        });
        return;
    }
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/contreras_final_comisiones_ingsoft1/permisos/eliminarAPI`;
        const config = {
            method: 'POST',
            headers: {
        ...
        try {
            ...
            if (codigo == 1) {
                ...
                await Swal.fire({
                    ...
                    icon: "error",
                    title: "Error",
                    text: mensaje || "Error al eliminar el permiso",
                    showConfirmButton: true,
                });
            }
