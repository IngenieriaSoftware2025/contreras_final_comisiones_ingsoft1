...
const guardarAplicacion = async e => {
    ...
    const url = "/contreras_final_comisiones_ingsoft1/aplicacion/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarAplicaciones = async () => {
    const url = `/contreras_final_comisiones_ingsoft1/aplicacion/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const ModificarAplicacion = async (event) => {
    ...
    const body = new FormData(formAplicacion);
    const url = '/contreras_final_comisiones_ingsoft1/aplicacion/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarAplicaciones = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/contreras_final_comisiones_ingsoft1/aplicacion/eliminar?id=${idAplicacion}`;
        const config = {
            method: 'GET'
        }
