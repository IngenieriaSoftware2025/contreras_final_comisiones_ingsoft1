...
const guardarUsuario = async e => {
    ...
    const url = "/contreras_final_comisiones_ingsoft1/usuarios/guardarAPI";
    const config = {
        method: 'POST',
        body
    }
...
const BuscarUsuarios = async () => {
    const url = `/contreras_final_comisiones_ingsoft1/usuarios/buscarAPI`;
    const config = {
        method: 'GET'
    }
...
const ModificarUsuario = async (event) => {
    ...
    const body = new FormData(formUsuario);
    const url = '/contreras_final_comisiones_ingsoft1/usuarios/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarUsuarios = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/contreras_final_comisiones_ingsoft1/usuarios/eliminar?id=${idUsuario}`;
        const config = {
            method: 'GET'
        }
