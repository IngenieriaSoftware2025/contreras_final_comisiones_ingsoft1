            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body bg-gradient" style="background: linear-gradient(90deg, #f8fafc 60%, #e3f2fd 100%);">
                    <div class="mb-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-0">GESTIÓN DE USUARIOS</h3>
                    </div>
                    <form id="formUsuario" class="p-4 bg-white rounded-3 shadow-sm border" enctype="multipart/form-data">
                        ...
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="usuario_nom2" name="usuario_nom2" placeholder="Ingrese segundo nombre" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="usuario_ape2" name="usuario_ape2" placeholder="Ingrese segundo apellido" required>
                            </div>
                        </div>
